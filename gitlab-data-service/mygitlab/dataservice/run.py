...
from mygitlab.dataservice.app import create_app
from mygitlab.dataservice.database import db, init_database
...
def main(args=sys.argv[1:]):
    parser = argparse.ArgumentParser(description='myGITLAB Dataservice')
